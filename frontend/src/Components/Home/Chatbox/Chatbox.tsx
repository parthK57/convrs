...
import { activeChatDetails, messageDetails } from "../Modals/Chatbox";


const Chatbox = () => {
  const [message, setMessage] = useState("");
  const messages : messageDetails = useSelector((state: any) => state.messages.value);
  const activeChatDetails : activeChatDetails = useSelector((state: any) =>state.activeChat.value);
  console.log("first", activeChatDetails);
